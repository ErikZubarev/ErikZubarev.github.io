document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        se: {
            ...
            firstParagraph5: 'Idag har jag en solid grund inom IT med en <strong>kandidatexamen i data- och systemvetenskap</strong>, en djup passion för AI och cybersäkerhet och en vilja att fortsätta lära mig. När jag ser mot framtiden är jag ivrig att använda mina färdigheter och erfarenheter för att bidra till innovativa och meningsfulla projekt.',
