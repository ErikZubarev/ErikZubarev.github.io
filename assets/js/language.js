document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        se: {
            ...
            firstParagraph3: 'Några år senare gick jag med i <strong>systemutvecklingsprogrammet på LBS</strong> (nuförtiden kallad "app- och webbutveckling"), och fördjupade min förståelse av IT. Trots att jag hade tre års programmeringserfarenhet från klubben insåg jag hur lite jag kunde. Jag började experimentera hemma, skapade enkla program som miniräknare och fil-läsare medan jag arbetade på webbsidor i skolan. Mina betyg blev tillslut så bra att rektorn erbjöd mig möjligheten att bli <strong>skolambassadör</strong>. Jag fick alltså delta i öppna hus, resor och samma Comic-Con-evenemang som hade inspirerat mig från början. Jag lärde mig att arbeta med nya människor, marknadsföra mig själv och min skola, och viktigast av allt, känna en känsla av engagemang och tillhörighet.',
        ...
        en: {
            ...
            firstheader2: 'Formal education, job experiences and achievements',
            ...
            firstParagraph3:'A few years later, I joined the <strong>software development program at LBS</strong> (nowadays called "app and web development"), furthering my understanding of IT. Despite having three years of programming experience from the club, I realized how little I knew. I began experimenting at home, creating simple programs like calculators and file readers while working on websites at school. My grades improved so much that the principal offered me the opportunity to become a <strong>school ambassador</strong>. I participated in the same Comic-Con events that had inspired me and learned how to work with new people, promote myself and my school, and most importantly, feeling a sense of engagement and belonging.',
