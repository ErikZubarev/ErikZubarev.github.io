document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        ...
        ru: {
            ...
            AboutMeParagraph2:'Хотя игры, созданные за три года в клубе, теперь утрачены, моя страсть к обучению и программированию была прочно установлена. Создавать игры было весело, но по мере приближения к старшей школе я начал осознавать, что хочу большего, чем просто игры. Случайно, я с другом прогуливались по Comic-Con, когда мы заметили новооткрытую стойку, рекламирующую старшую школу LBS Kreativa Gymnasiet, демонстрирующую игры, созданные ее студентами, и программы, доступные в их школе. Мы заподумались: "Могут ли студенты этой школы создавать такие вещи?"',
