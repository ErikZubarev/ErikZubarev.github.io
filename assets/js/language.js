document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        ...
        en: {
            ...
            ProjectsIntro:'<strong>This sections showcases the different projects I have worked on.</strong> These are some of the best projects that illustrate my knowlage and abilities. Each project links to my GitHub if you need access to the code',
